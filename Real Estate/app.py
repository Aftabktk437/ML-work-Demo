...
# # Load the trained Random Forest model
# random_forest_model = load('random_forest_model.h5')

# # Function to predict house price


# def predict_price(size, property_age, bedrooms, bathrooms, livingrooms, kitchen, garage, driver_room, maid_room, furnished, ac, roof, pool, frontyard, basement, duplex, stairs, elevator, fireplace):
#     input_features = [size, property_age, bedrooms, bathrooms, livingrooms, kitchen, garage, driver_room,
#                       maid_room, furnished, ac, roof, pool, frontyard, basement, duplex, stairs, elevator, fireplace]
#     predicted_price = random_forest_model.predict([input_features])
#     return predicted_price[0]
...
#         # Predict house price
#         predicted_price = predict_price(size, property_age, bedrooms, bathrooms, livingrooms, kitchen, garage,
#                                         driver_room, maid_room, furnished, ac, roof, pool, frontyard, basement, duplex, stairs, elevator, fireplace)
#         st.success(
#             f"The predicted price of the house is ${predicted_price:.2f}")
